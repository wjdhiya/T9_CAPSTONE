            ...
            <form method="POST" action="{{ isset($publikasi) ? route('publikasi.update', $publikasi) : route('publikasi.store') }}" enctype="multipart/form-data">
                ...
                <div class="bg-white rounded-xl shadow-xl p-6 mb-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div x-data="{ 
                                authors: [{ id: Date.now(), first: '{{ old('author.0.first', $publikasi->penulis_depan_0 ?? '') }}', last: '{{ old('author.0.last', $publikasi->penulis_belakang_0 ?? '') }}' }],
                                nextId: 1, 
                                addAuthor() {
                        ...
                        <div>
                            ...
                            @if(isset($publikasi) && $publikasi->file_path)
                                ...
                                <div class="file-upload-area" id="file_publikasi_replace">
                                    <label for="file_publikasi_hidden" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                            ...
                            @else
                                ...
                                <label for="file_publikasi_hidden" id="file_publikasi_upload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
