@php
    ...
    // 2. Cek Data Database
    elseif ($pengabdianMasyarakat->tim_abdimas ?? $pengabdianMasyarakat->anggota) {
        $decoded = json_decode($pengabdianMasyarakat->tim_abdimas ?? $pengabdianMasyarakat->anggota, true);
        if (is_array($decoded)) {
    ...
    // 2. Cek Data Database
    elseif ($pengabdianMasyarakat->anggota_mahasiswa ?? $pengabdianMasyarakat->mahasiswa) {
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="jenis_hibah" name="jenis_hibah" required
                                ...
                                <option value="internal" {{ old('jenis_hibah', $pengabdianMasyarakat->jenis_hibah) == 'internal' ? 'selected' : '' }}>Internal</option>
                                <option value="eksternal" {{ old('jenis_hibah', $pengabdianMasyarakat->jenis_hibah) == 'eksternal' ? 'selected' : '' }}>Eksternal</option>
                                <option value="mandiri" {{ old('jenis_hibah', $pengabdianMasyarakat->jenis_hibah) == 'mandiri' ? 'selected' : '' }}>Mandiri</option>
                            </select>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                ...
                                <input type="text" id="tahun" name="tahun" value="{{ old('tahun', $pengabdianMasyarakat->tahun) }}" required
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-telkom-blue focus:border-transparent transition-all"
